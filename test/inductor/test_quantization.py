...
class TestQuantization(TestCase):
        ...
        for key1 in ref_dict.keys():
            ...
            if (
                ...
                log.info(
                    ...
                    key1, ref_dict[key1], key2, res_dict[key2]
                )
                continue
    ...
    def test_activation_quantization_aten(self):
        ...
        self.assertEqual(counters["inductor"]["activation_quantization_fwd_aten_pass"], 1)
        self.assertEqual(counters["inductor"]["activation_quantization_bwd_aten_pass"], 1)
